...
function isEven(n) {
    ...
    else if (n < 1) return isEven(-n);  // recursion here with calling own function, not best practice but possible
...
console.log(countChar('kakerlaak', 'k'));

function countBs2(string, chr) {
    let counted = 0;
